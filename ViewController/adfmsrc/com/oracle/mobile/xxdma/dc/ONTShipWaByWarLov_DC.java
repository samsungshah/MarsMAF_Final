    ...
    public ONTShipWaByWarLov_DC() {
        ...
        public String[] getShipWarList() {
            if(ShipWarList == null){    
                ...
                AdfException e = new AdfException("Error Invoking getShipWarList", AdfException.WARNING);
                System.out.println("Error Invoking getShipWarList");

            }
            ShipWarList = (String[]) s_orgList.toArray(new String[s_orgList.size()]);
            System.out.println("getShipWarList complete");
            }
            
            System.out.println("Inside getShipWarList");
       ...
       //     payloadTH.setRespAppId(applnId);
           ...
           payloadTH.setRespAppId("660");
            ...
            GenericType payloadGT =  GenericTypeBeanSerializationHelper.toGenericType("ONTShipWaByWarLov_WL.Types.process.TransactionHeader", payloadTH);
            ...
            try {
                resultGT =
                    (GenericType) AdfmfJavaUtilities.invokeDataControlMethod("ONTShipWaByWarLov_WL", null, "process", pnames,
                                                                             pvals, ptypes);
                resultGT = resultGT.getParent();
                Object provider = AdfmfJavaUtilities.getDataControlProvider("ONTShipWaByWarLov_WL");
